...
SRC_URI = " \
    git://git@git.projects.openwide.fr/open-wide/efl-hybris-enlightenment.git;branch=devs/captainigloo/eglfs;protocol=ssh \
...
# Enable eglfs module
EXTRA_OECONF += "--enable-wl-eglfs --disable-mixer"
